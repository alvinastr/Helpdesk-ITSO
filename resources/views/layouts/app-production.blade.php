                            ...
                            @if(auth()->user()->role === 'admin')
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-start">
                                        ...
                                        <li><hr class="dropdown-divider"></li>
                                        <li><h6 class="dropdown-header">WhatsApp</h6></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.whatsapp.index') }}">
                                            <i class="fab fa-whatsapp"></i> WA Tickets
                                        </a></li>
                                        <li><a class="dropdown-item" href="{{ route('whatsapp.monitor') }}">
                                            <i class="fas fa-robot"></i> Bot Monitor
                                        </a></li>
                                    </ul>
                                </li>
                            @endif
